...
<section class="hero-bg min-h-screen relative overflow-hidden">
    ...
    {{-- NAVBAR --}}
    <nav class="relative z-20 container-custom flex items-center justify-between px-5 lg:px-8 py-4">
        ...
        <div class="hidden lg:flex items-center gap-7 text-white text-sm font-medium">
            ...
            <a href="#fitur" class="hover:text-blue-300 transition">
                Fitur & Layanan
            </a>
...
{{-- FOOTER --}}
<footer class="bg-[#0f172a] py-7 text-center text-gray-400 text-sm">
    <p>
        © 2026 Aplikasi RT — Sistem Informasi dan Pelayanan Warga
    </p>
</footer>
...
<script>
    function switchPublicTab(tabId, btn) {
        // Hide all contents
        document.querySelectorAll('.public-tab-content').forEach(content => {
